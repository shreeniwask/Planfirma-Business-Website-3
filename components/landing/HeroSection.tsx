...
export default function HeroSection({ onNavigate }: HeroSectionProps) {
  return (
    <ScrollAnimatedSection
      animation="fade-up"
      className="relative w-full bg-white py-4 sm:py-6 md:py-8 lg:py-12"
    >
          ...
          >
            <div className="space-y-3 sm:space-y-4 md:space-y-6">
              ...
              <div className="mb-5 sm:mb-6">
                ...
                <h1 className="text-[24px] sm:text-[28px] md:text-[32px] lg:text-[40px] xl:text-[48px] font-bold tracking-tight leading-tight ">
                    ...
                    <p className="text-[16px] sm:text-[18px] md:text-[20px] lg:text-[22px] text-gray-700 leading-relaxed max-w-2xl mx-auto lg:mx-0">
                      From idea validation to secure, scalable SaaS
                      platforms built for startups and growing businesses.
                    </p>
              ...
              <div>
                ...
                <p className="text-[16px] sm:text-[18px] md:text-[20px] lg:text-[22px] text-gray-700 leading-relaxed max-w-2xl mx-auto lg:mx-0">
                  We bring 14+ years of deep IT expertise to help businesses
                  streamline infrastructure, lock down security, and drive real
                  digital transformation—with no fluff, just results.
                </p>
              </div>
          ...
          >
            <div className="relative w-full h-64 sm:h-72 md:h-80 lg:h-96 xl:h-[400px] 2xl:h-[450px] min-h-[250px] rounded-3xl overflow-hidden shadow-2xl">
              <img
                ...
                onLoad={() =>
                  console.log("Landing hero image loaded successfully")
                }
                onError={(e) => {
