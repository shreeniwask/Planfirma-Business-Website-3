          ...
          <ScrollAnimatedCard animation="scale-in" delay={500} className="text-center max-w-lg mx-auto" hover={false}>
            <div className="flex flex-col sm:flex-row gap-6 justify-center">
              ...
              <button 
                ...
                className="bg-transparent border-2 border-[#2D993D] text-[#2D993D] px-10 py-5 rounded-lg font-semibold text-[16px] flex-1 sm:flex-none sm:px-12 btn-hover-secondary"
