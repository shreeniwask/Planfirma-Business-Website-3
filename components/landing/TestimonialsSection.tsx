  ...
  return (
    <ScrollAnimatedSection animation="fade-up" className="bg-gradient-to-b from-gray-50 to-white relative w-full">
      <div className="flex flex-col justify-center relative size-full">
        <div className="box-border content-stretch flex flex-col gap-8 md:gap-10 lg:gap-12 items-center justify-center px-4 md:px-8 lg:px-16 py-6 sm:py-8 md:py-10 lg:py-12 relative w-full">
